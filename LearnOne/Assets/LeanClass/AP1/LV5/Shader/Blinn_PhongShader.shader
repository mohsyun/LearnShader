...
////// Emissive:
                ...
                float node_3173 = pow(max(dot(halfDirection,i.normalDir),0.0),_SpaculerPower_var);
                float3 emissive = float3(node_3173,node_3173,node_3173);
